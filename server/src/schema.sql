...
CREATE TABLE IF NOT EXISTS consultorios (
  ...
  eslogan TEXT,
  tipografia TEXT NOT NULL DEFAULT 'fraunces' CHECK (tipografia IN ('fraunces','nunito','montserrat')),
  fondo_estilo TEXT NOT NULL DEFAULT 'imagen' CHECK (fondo_estilo IN ('imagen','degradado','color')),
  bienvenida TEXT,
  whatsapp TEXT,
  facebook TEXT,
  instagram TEXT,
...
CREATE TABLE IF NOT EXISTS consultorio_email (
  ...
  smtp_from TEXT,
  oauth_provider TEXT DEFAULT 'smtp',
  gmail_user TEXT,
  gmail_refresh_token_cifrado TEXT,
  gmail_access_token_cifrado TEXT,
  gmail_access_token_expira_en TEXT,
  activo INTEGER NOT NULL DEFAULT 1,
  verificado_en TEXT,
  ultimo_error TEXT,
  creado_en TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP,
